...
export class LoginComponent implements OnInit {
  ...
  constructor(private router:Router, private formBuilder: FormBuilder, private loginService: LoginService, private datosService:DatosService, private registroService: RegistroService) {

    this.registroService.login.subscribe(respuesta =>{
      if(respuesta!=null){
